...
export default function DateHeader({ day, month, year, getOrdinalSuffix, monthNames }: DateHeaderProps) {
  return (
    <div className="relative lg:absolute left-1/2 lg:top-[90px] -translate-x-1/2 lg:-translate-y-1/2 animate-fade-in px-4 z-10" style={{ animationDelay: '0.1s' }}>
      <p className="text-white text-[24px] lg:text-[48px] tracking-[4px] lg:tracking-[10.08px] text-center leading-snug" style={{ fontFamily: 'var(--font-poppins)' }}>
